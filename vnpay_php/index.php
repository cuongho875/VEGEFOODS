...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="/VEGEFOODS/vnpay_php/assets/bootstrap.min.css" rel="stylesheet"/>
        <!-- Custom styles for this template -->
        <link href="/VEGEFOODS/vnpay_php/assets/jumbotron-narrow.css" rel="stylesheet">  
        <script src="/VEGEFOODS/vnpay_php/assets/jquery-1.11.3.min.js"></script>
    </head>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <form action="/VEGEFOODS/vnpay_php/vnpay_create_payment.php" id="create_form" method="post">       
